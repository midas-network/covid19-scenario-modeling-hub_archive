...
Round 13: [Scenario Descriptions](https://github.com/midas-network/covid19-scenario-modeling-hub/blob/master/previous-rounds/README_Round13.md) and [Model Details]( https://github.com/midas-network/covid19-scenario-modeling-hub#teams-and-models)
...
In scenarios C and D (booster recommended for all adults 18+), teams should use **90% of the state-specific flu coverage reported for the 2021-2022 fall-winter season among adults 18+ (x0.90 of the flu vaccine coverage).** Refer to  [Flu coverage in adults](https://data.cdc.gov/Vaccinations/Cumulative-Influenza-Coverage-by-Race-Ethnicity-an/3myw-4j4q) for 2021-2022 data, while the flu vaccine [dashboard](https://www.cdc.gov/flu/fluvaxview/index.htm) has more extensive data from past seasons.  We will provide a complete time series of flu vaccination for 2021-2022, extrapolated from available data [here](https://data.cdc.gov/Vaccinations/Cumulative-Influenza-Cov). The distribution of who gets a booster among those for whom it is the 1st, 2nd or 3rd booster, and age differences in coverage within the 18+, is at the teams’ discretion.  </br>
