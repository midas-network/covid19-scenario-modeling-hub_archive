...
## Some underused features in Zoltar (as of now)
 ...
 - programmatic pushing of forecasts into Zoltar by teams (can be part of the model workflow, right now, forecasts are [pushed automatically from GitHub](https://github.com/midas-network/covid19-scenario-modeling-hub/actions?query=workflow%3A%22Trigger+zoltar+upload%22) every 6 hours)
