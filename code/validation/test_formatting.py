...
def check_formatting(my_path):
    ...
    link: https://github.com/midas-network/covid19-scenario-modeling-hub/wiki/Validation-Checks#current-validation-checks
...
def main():
    ...
    g = Github()
    repo = g.get_repo('midas-network/covid19-scenario-modeling-hub')    
